          ...
          <div className="profile__section">
            ...
            <div className="profile__security">
              {isPasswordEditing ? (
                ...
                <div className="profile__security-item">
                  ...
                  <Button
                    ...
                    title="Изменить"
                    className="profile__security-btn"
                    isSecondary
                  />
                </div>
              )}
              ...
              <div className="profile__security-item profile__security-item--danger">
                <div className="profile__security-info">
                  <h3 className="profile__security-title profile__security-title--danger">
                    Удаление аккаунта
                  </h3>
                  <p className="profile__security-description">
                    Это действие необратимо. После удаления аккаунта все ваши
